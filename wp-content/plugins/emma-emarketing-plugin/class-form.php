...
class Form {
    ...
    public function output() {
        ...
        $emma_form .= '<div class="input-label emma-required" for="emma-email">EMAIL ADDRESS</div>';
        $emma_form .= '<input id="emma-email" class="emma-form-input form-input" type="text" name="emma_email" size="30" placeholder="' . $this->form_setup_settings['email_placeholder'] . '">';
        ...
        $emma_form .= '<div class="submit-btn emma-submit">';
        $emma_form .= '<input id="emma_submit" type="submit" name="emma_form_submit" value="' . $this->form_setup_settings['submit_txt'] . '">';
		$emma_form .= '</div>';
        $emma_form .= '</form>';
