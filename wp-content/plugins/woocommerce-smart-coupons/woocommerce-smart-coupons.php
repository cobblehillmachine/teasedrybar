        ...
        class WC_Smart_Coupons {
            ...
            function get_expiration_format( $expiry_date ) {
                ...
                if( $expiry_days < 1 ) {
                    ...
                    $expires_string = __( 'Expires on ', 'wc_smart_coupons' ) . esc_html( date_i18n( 'F j, Y', strtotime( $expiry_date ) ) );
                    ...
                    foreach( $order_used_coupons as $code ) {
                                                ...
                                                if ( array_key_exists( $code, $smart_coupons_contribution ) ) {
                                                    ...
                                                    if($smart_coupon->type == 'smart_coupon' ) {
                                                            ...
                                                            $discount_amount = bcsub( (string)$smart_coupon->amount, (string)$smart_coupons_contribution[$code], 2 );
